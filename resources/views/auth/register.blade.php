...
<div class="wrapper">
    ...
    <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
            ...
            <form action="{{ route('registerPost') }}" method="POST" id="register-form">
                @csrf
                ...
                <div class="form-group mb-3">
                    <div class="input-group">
                        ...
                        <button class="btn border-0 bg-white" type="button" id="togglePasswordConfirmation">
                            <i class="bi bi-eye"></i>
                        </button>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-danger w-100" id="register">ĐĂNG KÝ</button>
                <p class="text-center text-white mt-2" style="font-size: 20px;">Bạn đã có tài khoản? <a class="text-danger text-decoration-none" href="{{ route('login') }}">Đăng nhập</a></p>
            </form>
        </div>
...
<script>
    $('#register-form').submit(function(e) {
        ...
        // add loading
        $('#register').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Đang đăng ký...');
