        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6 text-center" id="last-game">
                    <p class="card-title">Kết quả phiên {{ $lastGame ? $lastGame->code : '' }}</p>
                    <div class="ball_xs" style="margin: 0.3rem auto; justify-content: center;">
                        @foreach(str_split($lastGame->result[0][0]) as $number)
                    ...
                    <table id="table-xsmb" class="table-result table table-bordered table-striped table-xsmb text-center">
                        <tbody>
                            <tr>
                                ...
                                <td><span id="mb_prize_0" class="special-prize div-horizontal text-danger">{{ $lastGame ? $lastGame->result[0][0] : '' }}</span></td>
                            </tr>
                            <tr>
                                <th>1</th>
                                <td><span id="mb_prize_1" class="prize1 div-horizontal">{{ $lastGame ? $lastGame->result[1][0] : '' }}</span></td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <td><span id="mb_prize_2" class="prize2 div-horizontal">{{ $lastGame ? $lastGame->result[2][0] : '' }}</span><span id="mb_prize_3" class="prize2 div-horizontal">{{ $lastGame ? $lastGame->result[2][1] : '' }}</span></td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <td><span id="mb_prize_4" class="prize3 div-horizontal">{{ $lastGame ? $lastGame->result[3][0] : '' }}</span><span id="mb_prize_5" class="prize3 div-horizontal">{{ $lastGame ? $lastGame->result[3][1] : '' }}</span><span id="mb_prize_6" class="prize3 div-horizontal">{{ $lastGame ? $lastGame->result[3][2] : '' }}</span><span id="mb_prize_7" class="prize3 div-horizontal">{{ $lastGame ? $lastGame->result[3][3] : '' }}</span><span id="mb_prize_8" class="prize3 div-horizontal">{{ $lastGame ? $lastGame->result[3][4] : '' }}</span><span id="mb_prize_9" class="prize3 div-horizontal">{{ $lastGame ? $lastGame->result[3][5] : '' }}</span></td>
                            </tr>
                            <tr>
                                <th>4</th>
                                <td><span id="mb_prize_10" class="prize4 div-horizontal">{{ $lastGame ? $lastGame->result[4][0] : '' }}</span><span id="mb_prize_11" class="prize4 div-horizontal">{{ $lastGame ? $lastGame->result[4][1] : '' }}</span><span id="mb_prize_12" class="prize4 div-horizontal">{{ $lastGame ? $lastGame->result[4][2] : '' }}</span><span id="mb_prize_13" class="prize4 div-horizontal">{{ $lastGame ? $lastGame->result[4][3] : '' }}</span></td>
                            </tr>
                            <tr>
                                <th>5</th>
                                <td><span id="mb_prize_14" class="prize5 div-horizontal">{{ $lastGame ? $lastGame->result[5][0] : '' }}</span><span id="mb_prize_15" class="prize5 div-horizontal">{{ $lastGame ? $lastGame->result[5][1] : '' }}</span><span id="mb_prize_16" class="prize5 div-horizontal">{{ $lastGame ? $lastGame->result[5][2] : '' }}</span><span id="mb_prize_17" class="prize5 div-horizontal">{{ $lastGame ? $lastGame->result[5][3] : '' }}</span><span id="mb_prize_18" class="prize5 div-horizontal">{{ $lastGame ? $lastGame->result[5][4] : '' }}</span><span id="mb_prize_19" class="prize5 div-horizontal">{{ $lastGame ? $lastGame->result[5][5] : '' }}</span></td>
                            </tr>
                            <tr>
                                <th>6</th>
                                <td><span id="mb_prize_20" class="prize6 div-horizontal">{{ $lastGame ? $lastGame->result[6][0] : '' }}</span><span id="mb_prize_21" class="prize6 div-horizontal">{{ $lastGame ? $lastGame->result[6][1] : '' }}</span><span id="mb_prize_22" class="prize6 div-horizontal">{{ $lastGame ? $lastGame->result[6][2] : '' }}</span></td>
                            </tr>
                            <tr>
                                <th>7</th>
                                <td><span id="mb_prize_23" class="prize7 div-horizontal">{{ $lastGame ? $lastGame->result[7][0] : '' }}</span><span id="mb_prize_24" class="prize7 div-horizontal">{{ $lastGame ? $lastGame->result[7][1] : '' }}</span><span id="mb_prize_25" class="prize7 div-horizontal">{{ $lastGame ? $lastGame->result[7][2] : '' }}</span><span id="mb_prize_26" class="prize7 div-horizontal">{{ $lastGame ? $lastGame->result[7][3] : '' }}</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        socket.on(`reward-win-xoso3p-${userId}`, (data) => {
            Toastify({
